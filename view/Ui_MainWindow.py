...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.anchorTable.verticalHeader().setDefaultSectionSize(25)
        ...
        self.tagTable.verticalHeader().setHighlightSections(True)

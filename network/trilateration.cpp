...
{
	cout<<"This is test for function gdoprate"<<endl;
...
{
	// cout<<"This is test for function sphereline"<<endl;
...
{
	// cout<<"This is test for function trilateration"<<endl;
...
int deca_3dlocate (	vec3d	*const solution1,
					...
					int *combination)
{
	// cout<<"This is test for function deca_3dlocate"<<endl;
...
{
	// cout<<"This is test for function GetLocation"<<endl;
    ...
    cout<< "GetLocation--" << "sol1: " << o1.x <<", "<< o1.y  <<", "<< o1.z  << "; sol2: " << o2.x  <<", "<< o2.y  <<", "<< o2.z<<endl;
